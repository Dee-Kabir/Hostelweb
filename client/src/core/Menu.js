...
export const HomepageHeading = ({ mobile, pathname }) => {
  ...
  return (
    <Container text>
      ...
      <Header
        ...
        content={
          path != "/post/create"
            ? "The Whole World Is your Diary"
            : "The Whole World is Full of New Things Read Now"
        }
        inverted
        style={{
      ...
      <Header
        ...
        content={
          path != "/post/create"
            ...
            : "Read before you're out of this world"
        }
        inverted
        style={{
      ...
      <Button
        as={Link}
        to={path == "/post/create" ? "/" : "post/create"}
        primary
        size="huge"
      >
        {path == "/post/create" ? "Read now" : "Write now"}
      ...
      <Media greaterThan="mobile">
        ...
        >
          ...
          >
            ...
            <HomepageHeading pathname={this.props.pathname} />
          </Segment>
        </Visibility>
